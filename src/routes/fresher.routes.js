...
const { studentIdCheck, saveChecklistCheck } = require('../validators/request.validator');
...
router.post('/checklists/:studentId', saveChecklistCheck, fresherController.saveChecklist);
