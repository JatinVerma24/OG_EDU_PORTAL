...
// ── Firebase: Protected route – authenticated user profile ─────────────────────
...
// GET /api/notes — list all units
app.get('/api/notes', (req, res) => {
    const units = UNIT_META.map(u => ({
        id: u.id,
        title: u.title,
        icon: u.icon,
        color: u.color,
...
// GET /api/notes/:unitId — get raw markdown for one unit
